...
<ol class="breadcrumb">
    <li class="breadcrumb-item">
        <a href="<?php echo e(url('/client/search')); ?>">顧客検索</a>
    </li>

    <li class="breadcrumb-item">
        <a href="<?php echo e(url('/client/create')); ?>">新規登録</a>
    </li>

    <li class="breadcrumb-item">
        <a href="<?php echo e(url('/client/search')); ?>">配車</a>
    </li>

    <li class="breadcrumb-item">
        <a href="<?php echo e(url('/client/search')); ?>">完了報告</a>
    </li>
</ol>
    ...
    <div class="card-body">
        <div class="table-responsive">
            <div width="100%" cellspacing="0">
                ...
                <input name="admin_name" type="text" value="<?php echo e($client->name ?? ''); ?>"> 
                <input name="admin_id" type="hidden" value=""> <BR>

                <span class="title">識別番号</span>
                <input name="code_id" type="text" value="<?php echo e($client->post_code ?? ''); ?>">
                ...
                <div>
                    ...
                    <select name="staff">
                        <option>選択しない</option>
                        <option value="" <?php echo e($client->staff_id ?? ''); ?> >作業員1</option>
                        <option value="" <?php echo e($client->staff_id ?? ''); ?> >作業員2</option>
                    </select>
                ...
                <div>
                    <span class="title">顧客名</span><input name="name" type="text" value="<?php echo e($client->name ?? ''); ?>"><br>

                    <div style="width:100%;">
                        <span class="title">住所</span><input name="address" type="text" value="<?php echo e($client->address ?? ''); ?>" style="width:65%;"><br>
                    </div>

                    <span class="title">性別</span>        
                    <select name="sex">
                        <option></option>
                        <option value="1" <?php if($client->sex ?? '' == 1): ?> selected=selected <?php endif; ?>>男性</option>
                        <option value="2" <?php if($client->sex ?? '' == 2): ?> selected=selected <?php endif; ?>>女性</option>
                    </select>
...
-->
<div>
    <a href="<?php echo e(url('/customers/create')); ?>" class="btn btn-success" role="button">登録する</a>
</div>
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\kokyakukanri\resources\views/client/create.blade.php ENDPATH**/ ?>